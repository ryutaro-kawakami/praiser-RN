...
const styles = StyleSheet.create({
  ratioArea: {paddingTop: 20},
  graphContainer: {flexDirection: 'row', justifyContent: 'center'},
  headerTextContainer: {paddingLeft: 20, marginBottom: 8},
  text: {color: COLOR.WHITE, fontSize: 20, marginVertical: 3},
  numberText: {marginLeft: 8},
  textContainer: {
